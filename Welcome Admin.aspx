<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Welcome Admin.aspx.cs" Inherits="gamer_management2.Welcome_Admin" %>
...
<body class="bg-dark" style="width: 100%; height: 700px">
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="42pt" ForeColor="#990000" Text="WELCOME GAMER" CssClass="text-white"></asp:Label>
            <div class="text-left">
...
<div class="btn-group-vertical">
    ...
    <asp:Button CssClass="btn btn-warning" ID="Button3" runat="server" Text="Users" Width="162px" Font-Size="Large" Height="36px"  OnClick="Button3_Click" />
     <br />
    <asp:Button CssClass="btn btn-warning" ID="Button4" runat="server" Text="Access Request" Width="162px" Font-Size="Large" Height="36px"  OnClick="Button4_Click" />
